...
Neither of those things will happen. The method will work as we intended because Ruby is smart and has a few tricks up its sleve to help determine what method arguments are being used where in a method's body. 
